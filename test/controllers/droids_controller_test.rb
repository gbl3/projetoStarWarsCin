...
class DroidsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create droid" do
    assert_difference('Droid.count') do
      post droids_url, params: { droid: { ano_fabricacao: @droid.ano_fabricacao, id_fabricacao: @droid.id_fabricacao, serial_name: @droid.serial_name } }
    end
  ...
  test "should update droid" do
    patch droid_url(@droid), params: { droid: { ano_fabricacao: @droid.ano_fabricacao, id_fabricacao: @droid.id_fabricacao, serial_name: @droid.serial_name } }
