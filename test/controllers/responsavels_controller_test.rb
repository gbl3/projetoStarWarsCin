...
class ResponsavelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create responsavel" do
    assert_difference('Responsavel.count') do
      post responsavels_url, params: { responsavel: { cod_padawan: @responsavel.cod_padawan, nome: @responsavel.nome, planeta_origem: @responsavel.planeta_origem } }
    end
  ...
  test "should update responsavel" do
    patch responsavel_url(@responsavel), params: { responsavel: { cod_padawan: @responsavel.cod_padawan, nome: @responsavel.nome, planeta_origem: @responsavel.planeta_origem } }
